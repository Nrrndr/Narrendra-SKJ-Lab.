...
mulnum.exe:     file format pei-x86-64
...
0000000140001540 <main>:
   ...
   14000154d:	c7 45 fc 05 00 00 00 	movl   $0x5,-0x4(%rbp)
   140001554:	c7 45 f8 0a 00 00 00 	movl   $0xa,-0x8(%rbp)
   14000155b:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
   140001562:	8b 45 fc             	mov    -0x4(%rbp),%eax
   140001565:	0f af 45 f8          	imul   -0x8(%rbp),%eax
   140001569:	89 45 f4             	mov    %eax,-0xc(%rbp)
   14000156c:	b8 00 00 00 00       	mov    $0x0,%eax
   140001571:	48 83 c4 30          	add    $0x30,%rsp
